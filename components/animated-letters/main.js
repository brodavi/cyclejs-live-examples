...
import {ul, li, div, p, a} from '@cycle/dom'
...
function view (state$) {
  ...
  return animatedState$.map(animStates =>
    div([
      p([
        a({href: 'https://github.com/cyclejs/examples/tree/master/animated-letters',
           style: {'font-size': '10px'}}, 'https://github.com/cyclejs/examples/tree/master/animated-letters')
      ]),
