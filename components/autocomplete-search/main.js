...
import {ul, li, span, input, div, section, label, p, a} from '@cycle/dom'
  ...
  return state$.map(state => {
    ...
    return (
      div('.container', {style: containerStyle}, [
        p([
          a({href: 'https://github.com/cyclejs/examples/tree/master/autocomplete-search',
             style: {'font-size': '10px'}}, 'https://github.com/cyclejs/examples/tree/master/autocomplete-search')
        ]),
